...
import Svg, { Defs, LinearGradient, Stop, G, Line, Text as SvgText, Path } from 'react-native-svg';
...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.mainContainer}>
      {isLargeScreen && <DesktopNav currentRoute="Home" />}

      <AnimatedScreen style={styles.animatedContent}>
        <ScrollView style={styles.container} contentContainerStyle={[styles.content, isLargeScreen && styles.contentDesktop]}>
          {/* Background Grid */}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.accessGrid}>
              ...
              <TouchableOpacity
                style={styles.accessCard}
                onPress={() => router.push('/loot-cheat-sheet')}
              >
                <View style={styles.accessIcon}>
          ...
          {trackedQuests.length > 0 && (
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                ...
                <TouchableOpacity onPress={() => router.push('/quests')} style={styles.manageButton}>
          ...
          <View style={[styles.bottomRow, isLargeScreen && styles.bottomRowDesktop]}>
            {/* Dev Log */}
            <View style={[styles.patchSection, isLargeScreen && styles.patchSectionDesktop]}>
            ...
            {/* Field Notes */}
            <View style={[styles.tipsSection, isLargeScreen && styles.tipsSectionDesktop, !isLargeScreen && styles.tipsSectionMobile]}>
              <View style={styles.sectionHeader}>
                <View style={styles.sectionAccentYellow} />
